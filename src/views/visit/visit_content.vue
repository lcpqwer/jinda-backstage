    ...
    export default {
        ...
        methods: {
            ...
            hangEdit (row) {
                ...
                this.axios('Reference/content_detail', {
                    url: 'Reference/content_detail',
                    method: 'post',
                    data: $qs.stringify({
                        Id: row.Id
                    })
                }).then(res => {
                    this.formItem.Leader = res.data.table.Leader;
                    this.formItem.type = res.data.table.type;
                    this.formItem.name = res.data.table.name;
                    this.formItem.phone = res.data.table.phone;
                    this.formItem.company_phone = res.data.table.company_phone;
                    //
                    this.formItem.shi_name = res.data.table.shi;
                    this.formItem.city_name = res.data.table.city;
                    this.formItem.dist_name = res.data.table.dist;
                    this.formItem.address = res.data.table.address;
